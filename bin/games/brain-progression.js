const arithProgression = {
    ...
    /* set new value */
    newValue: function () {
      const arrLength = Math.floor(Math.random() * (this.maxLen - this.minLen) + this.minLen)
    ...
    isCorrect: function (userAnswer) {
      return userAnswer == this.value[this.unknownIndex] ? true : false
    },
}
  
  export { arithProgression as default }